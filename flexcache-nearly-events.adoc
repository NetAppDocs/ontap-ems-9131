...
[.lead]
flexcache.nearly events are presented when the total cluster-wide FlexCache provisioned space has nearly reached the licensed limit, which may be fixed by to increase the licensed capacity, install a new license in the cluster.

...
[.lead]
dbs.secondary events are presented when the Distributed Block Store (DBS) detects that Slice volume secondary write cache has reached the first fullness warning threshold.

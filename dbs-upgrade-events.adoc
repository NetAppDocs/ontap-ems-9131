...
[.lead]
dbs.upgrade events are presented when Distributed Block Store (DBS) detects a software upgrade is in progress longer than 24 hours, which may be fixed by contact netapp technical support.

...
[.lead]
dbs.remote EMS events occur when ONTAP encounters issues associated with remote cluster connectivity or replication in the Distributed Block Store (DBS).

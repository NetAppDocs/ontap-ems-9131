...
[.lead]
dbs.fault events are presented when a Distributed Block Store (DBS) event related to the fault checker occurs, such as excessive time for the periodic fault checker to execute.

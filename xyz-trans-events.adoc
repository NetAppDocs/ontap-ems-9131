...
[.lead]
xyz.trans EMS events occur when Copy-Free Transition's volume transition job, responsible for transitioning 7-Mode volumes to clustered Data ONTAP(R), starts.

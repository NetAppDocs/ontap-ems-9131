...
[.lead]
flexcache.capacity events are presented when the total cluster-wide FlexCache provisioned space has exceeded the licensed limit, which may be fixed by to increase the licensed capacity, install a new license in the cluster.

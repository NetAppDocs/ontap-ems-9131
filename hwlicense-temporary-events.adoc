...
[.lead]
hwlicense.temporary events are presented when the system detects a temporary hardware license, which may be fixed by install a valid permanent hardware license.

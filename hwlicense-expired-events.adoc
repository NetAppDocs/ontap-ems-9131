...
[.lead]
hwlicense.expired events are presented when the system detects an expired hardware license, which may be fixed by install a valid permanent hardware license.

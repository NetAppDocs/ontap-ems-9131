...
[.lead]
dipmon.dataip events are presented when a data IP address becomes responsive on the node on which it is hosted and has been committed to the Zookeeper database.

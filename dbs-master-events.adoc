...
[.lead]
dbs.master events are presented when the node fails to execute cluster master startup. The system attempts to start the cluster master again automatically.

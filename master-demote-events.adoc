...
[.lead]
master.demote events are presented when the associated node successfully updates the global database to demote current cluster master. As a result, a new cluster is promoted.
